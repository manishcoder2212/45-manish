...
box=new Box(1050,140,300,100)

stone1=new Stone(900,60)
stone2=new Stone(900,180)
...
arrow1.display();
  ...
  function keyPressed() { 
    if (keyCode === UP_ARROW) { 
      ...
      Matter.Body.applyForce(stone1.body,stone1.body.position,{x:-0.5,y:1});

      Matter.Body.setStatic(stone2.body,false) 
      Matter.Body.applyForce(stone2.body,stone2.body.position,{x:-0.5,y:1});

      Matter.Body.applyForce(box.body,box.body.position,{x:-0.5,y:1});
